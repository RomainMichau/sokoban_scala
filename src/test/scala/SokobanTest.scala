...
class SokobanTest extends FunSuite {
 ...
 test("level file reader"){
  assert(levels.toSeq.toString() == "WrappedArray(test/levels/test/test_1.dat, test/levels/test/test_4.dat, test/levels/test/test_2.dat, test/levels/easy/easy_1.dat, test/levels/easy/easy_2.dat)")
 }
